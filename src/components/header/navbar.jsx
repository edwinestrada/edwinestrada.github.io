...
const NavBar = () => (<>
  <div className="hide-on-mobile">
    ...
    <div className="clearfix mt1">
      <a href="https://drive.google.com/file/d/1gmaoUe7BsK60DhVtdxxaPZwPR-Zo-sgm/view" target="_blank" rel="noopener noreferrer"><button className="btn caps bold mb1">Download Resume</button></a>
    </div>
  </div>
